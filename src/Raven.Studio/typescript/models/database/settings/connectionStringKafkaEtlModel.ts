...
class connectionStringKafkaEtlModel extends connectionStringModel {
    ...
    initValidation() {
        ...
        // todo: is connection options required ?
        // this.connectionOptions.extend({
        //     validation: [
        //         {
        //             validator: () => this.connectionOptions().length > 0,
        //             message: "Must provide at lease one connection option"
        //         }
        //     ]
        // }); 
        ...
        //     validation: [
        //         {
        //             validator: () => this.connectionOptions().forEach(x => !viewHelpers.isValid(x.validationGroup)),
        //             message: "xxxxxx"
        //         }
        //     ]
        // });
        ...
        this.validationGroup = ko.validatedObservable({
            ...
            // connectionOptions: this.connectionOptions.isValid()
            // connectionOptions: this.connectionOptions().forEach(x => x.isValid())
        });
    }
