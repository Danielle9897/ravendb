...
class ongoingTaskOlapEtlEditModel extends ongoingTaskEditModel {
    ...
    runFrequencyCronEditor = ko.observable<cronEditor>(); // todo..
    ...
    initializeValidation() {
        ...
        this.enterTestModeValidationGroup = ko.validatedObservable({  // todo...
            connectionStringName: this.connectionStringName,
            olapTables: this.olapTables
        });
    }
    ...
    update(dto: Raven.Client.Documents.Operations.OngoingTasks.OngoingTaskOlapEtlDetails) {
        ...
        if (configuration) {
            ...
            // hard coded for now - until server is fixed - todo...
            configuration.RunFrequency = "0 2 * * *";
            
            this.runFrequencyEnabled(!!configuration.RunFrequency); // todo... check this...   
    ...
    toDto(): Raven.Client.Documents.Operations.ETL.OLAP.OlapEtlConfiguration {
        return {
            ...
            CustomPrefix: this.customPrefixEnabled() ? this.customPrefix() : null, // todo.. check...
            KeepFilesOnDisk: this.keepFilesOnDisk(),
            
            // RunFrequency: this.runFrequencyEnabled() ? this.runFrequency() : null, // todo ... check this...
            RunFrequency: null, // todo..  hard coded for now...
