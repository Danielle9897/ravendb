...
//
//     markersGroups: MarkerClusterGroup[] = [];
//
...
//         this.createMap(this.markersLayers());
//     }
//
//     addMarkersToMap(moreMarkers: Array<spatialMarkersLayerModel>): void {
//         this.createMap(moreMarkers, false);
//     }
//
//     private createMap(markers: Array<spatialMarkersLayerModel>, newMap: boolean = true): void {
...
//
//         this.markersGroups.forEach(group => this.map.addLayer(group));
//         this.map.addLayer(polyLayer);
//         this.map.addLayer(circleLayer);
//
//         const mapBounds = L.latLngBounds([]);
//         this.markersGroups.forEach(group => mapBounds.extend(group.getBounds()));
//
...
// try create new map with bigger markers array
//
import viewModelBase = require("viewmodels/viewModelBase");
import spatialMarkersLayerModel = require("models/database/query/spatialMarkersLayerModel");
import document = require("models/database/documents/document");
