...
type quoteChars = "Double quote" | "Single quote" | "None";
type trimOptions = "No trimming" | "Trim whitespace around field" | "Trim whitespace inside quotes";

class csvConfiguration {
   
    possibleDelimiters = ko.observableArray<delimiters>(["Comma", "Semicolon", "Tab", "Space"]);
    possibleQuoteChars = ko.observableArray<quoteChars>(["Double quote", "Single quote", "None"]);
    possibleTrimOptions = ko.observableArray<trimOptions>(["No trimming", "Trim whitespace around field", "Trim whitespace inside quotes"]);        
    ...
    getTrimOption(): CsvHelper.Configuration.TrimOptions {
        switch (this.selectedTrimOption()) {
            ...
            case "Trim whitespace around field": return "Trim";
            case "Trim whitespace inside quotes": return "InsideQuotes";
        }
    }
}
