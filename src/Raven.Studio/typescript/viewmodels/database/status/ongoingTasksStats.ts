...
class hitTest {
    ...
    private handleSubscriptionExceptionTooltip: (context: subscriptionErrorItemInfo, x: number, y: number) => void;
    ...
    init(container: d3.Selection<any>,
        ...
        handleSubscriptionExceptionTooltip: (context: subscriptionErrorItemInfo, x: number, y: number) => void,
    ...
    onMouseMove() {
        ...
        if (currentTrackEventItem) {
            this.handleSubscriptionExceptionTooltip(currentTrackEventItem.arg as subscriptionErrorItemInfo , clickLocation[0], clickLocation[1]);
            this.cursor("auto");
            return;
        }
...
class ongoingTasksStats extends viewModelBase {
    ...
    private handleSubscriptionExceptionTooltip(itemInfo: subscriptionErrorItemInfo, x: number, y: number) {
        const currentDatum = this.tooltip.datum();
