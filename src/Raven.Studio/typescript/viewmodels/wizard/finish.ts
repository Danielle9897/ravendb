...
class finish extends setupStep {
    ...
    // private saveConfigurationAndCreatePackage(url: string, dto: Raven.Server.Commercial.SetupInfo) {
    private saveConfigurationAndCreatePackage(url: string, dto: Raven.Server.Commercial.SetupInfoBase) { // todo .. check this....
