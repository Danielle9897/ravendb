...
class globalSettings extends abstractSettings {
    ...
    pinnedDocumentProperties = new simpleStudioSetting<boolean | undefined>("local", false, x => this.saveSetting(x));
    pinnedMenu = new simpleStudioSetting<boolean | undefined>("local", true, x => this.saveSetting(x));
