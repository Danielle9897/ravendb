...
namespace Raven.Client.ServerWide.Operations.Logs
{
    ...
    public class GetLogsConfigurationResult
    {
        ...
        /// <summary>
        /// Logs retention time (returns null (TimeSpan.Zero) if RetentionTime is TimeSpan.MaxValue
        /// </summary>
        public TimeSpan RetentionTime { get; set; }
        
        /// <summary>
        /// Logs retention size (returns null if RetentionSize is long.MaxValue)
        /// </summary>
